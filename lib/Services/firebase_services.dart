...
Future<List> getPeople() async {
  ...
  for (var doc in queryPeople.docs) {
    ...
    final person = {
      ...
      "paymentMethod": data['paymentMethod'], // Agregado el campo 'paymentMethod'
      "uid": doc.id,
    };
    people.add(person);
  }
...
Future<void> addPeople(String id, String name, int age, String phone, String email, String address, String paymentMethod) async {
...
Future<void> updatePeople(String uid, String newId, String newName, int newAge, String newPhone, String newEmail, String newAddress, String newPaymentMethod) async {
